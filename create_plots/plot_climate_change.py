...
model_name = f"BayesianNN_Heteroscedastic_16_16_N{N_train}_priorNormal(0,1.0)"
run_types = ["aleatoric_AR1", "fixed_epistemic", "fixed_both_AR1"] #, "aleatoric",] # Or run_types = ["epistemic_fix", "aleatoric_AR1_", ...]
label_names = [ "Aleatoric (AR1)",  "Epistemic (PPE)", "Both (PPE)"]
