...
for F_test in F_tests:
    ...
    plot_distributions(params, model_name, run_types, label_names, det=True,
        save_prefix=save_prefix, fnames=fnames, linestyles=linestyles, spatial_mean=True)

    plot_runningmean_distributions(params, model_name, run_types, label_names, det=True,
