...
# Run one initial condition and compare uncertainty after time t=0.6 MTU 
# (saved as "_1_" so we don't overwrite the full simulations)
...
# Model name
N_trains = [20, 40, 60, 80, 120, 140, 160, 180]
for N_train in N_trains:
    ...
    test_params['save_prefix'] = 'epistemic_1_' 
    ...
    test_params['save_prefix'] = 'aleatoric_1_' 
    test(params, test_params, param_func)
    ...
    test_params['save_prefix'] = 'both_1_' 
    test(params, test_params, param_func)
    ...
    test_params['save_prefix'] = 'deterministic_1_' 
    test_params['n_ens'] = 1
    test(params, test_params, param_func)
