...
def plot_distributions(params, model_name, run_types, label_names, fnames="X_dtf",
    fnames_true=None, det=False, save_prefix="", linestyles = None):
    """Plots distributions """
    ...
    #plt.legend()
    plt.tight_layout()
    plt.savefig(f"{plot_path}{save_prefix}X_pdf_and_diff.png")
    print(f"Saved to {plot_path}{save_prefix}X_pdf_and_diff.png")
