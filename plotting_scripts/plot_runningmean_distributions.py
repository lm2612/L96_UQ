...
def plot_runningmean_distributions(params, model_name, run_types, label_names, fnames="X_dtf",
    ...
    #plt.legend()
    plt.tight_layout()
    plt.savefig(f"{plot_path}{save_prefix}X_pdf_and_diff_running_mean{running_mean_window}.png")
    print(f"Saved to {plot_path}{save_prefix}X_pdf_and_diff_running_mean{running_mean_window}.png")
...
if __name__ == "__main__":
    ...
    plot_cc_anom_distributions(params, model_name, run_types, label_names, save_prefix=save_prefix, 
